...
const uri = "mongodb+srv://"+DB_USERNAME+":"+DB_PASSWORD+"@testingclister.vvy0v.mongodb.net/?retryWrites=true&w=majority&appName=TestingClister";
...
async function queryDatabase() {
    try {
      ...
      const results = await collection.find({}).toArray(); //toArray()
...
//this section here handles all the api routes
